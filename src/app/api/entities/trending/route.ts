...
import { getMockTrendingEntities } from '../../../../lib/mock-data'
...
export async function GET(request: NextRequest) {
  try {
    ...
    try {
      ...
      console.log('Database unavailable, using mock trending data:', dbError)
      return NextResponse.json(
        getMockTrendingEntities(query.limit),
    ...
    return NextResponse.json(getMockTrendingEntities(10))
  }
}
